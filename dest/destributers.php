...
<head>
  <title>Distributers || Alpha Business</title>
...
<body>
  <div class="container">
    <header>
      ...
      <div class="pagetitle">
        <p><i class="fas fa-align-justify"></i> Distributers List</p>
      </div>
    </header>
    <section class="data">
      <div class="details">
        ...
        <form action="adest.php" method="post" class="action AddRec">
          <fieldset>
            <table>
              ...
              <tr>
                <td>Mobile *</td>
                <td><input type="text" name="mobile" maxlength="10" id="" required ></td>
              </tr>
              <tr>
                <td>GST Number *
                </td>
                <td>
                  <input type="text" name="greg" required >
                </td>
              </tr>
              <tr>
                <td>Email </td>
