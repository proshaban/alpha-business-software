    ...
    <section class="data">
      <div class="details">
        <table>
          ...
          <tr>
            <td>Primary Phone</td>
            <td colspan="2">: <?php echo $mobile1 ?></td>
          </tr>
          <tr>
            <td>Secondary Phone</td>
            <td colspan="2">: <?php echo $mobile2 ?></td>
          </tr>
          <tr>
            <td align="center">
        ...
        <div class="actions">
          <button onclick="location.href='customers.php'" ><i class="fas fa-arrow-left"></i> Go Back</button>
          ...
          <button onclick="location.href='newbill/addnew.php?cusId=<?php echo $cusid ?>'"><i class="fas fa-file-medical"></i> New Bill</button>
        </div>
